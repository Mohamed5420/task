...
import 'package:task/core/widgets/svg_icons/app_loader_image.dart';
    ...
    if (widget._enableLogo) {
      return Center(
        child: SizedBox(
          ...
          //   ],
          // ),
          child: CupertinoActivityIndicator(color: context.colors.secondary,),
        ),
      );
    } else {
