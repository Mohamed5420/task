...
import 'package:task/core/constants/input_field_style/custom_input_decoration.dart';
      ...
      builder: (_) => Dialog(
        ...
        child: Column(
          children: <Widget>[
                ...
                Positioned(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.close,color: context.colors.white,size: 18,),
                    ),
                  ),
                ),
                Center(
            ...
            Expanded(
              child: CountryPickerWidget(
                itemTextStyle: AppTextStyle.s12_w600(color: context.colors.black),
                searchInputStyle: AppTextStyle.s12_w500(color: context.colors.black),
                searchInputDecoration: CustomInputDecoration(
                  hint: 'Search country name/code',
