...
class Gaps {
  ...
  static Widget vGap22 = const SizedBox(height: Dimens.dp20);
  ...
  static Widget vGap96 = const SizedBox(height: Dimens.dp96);
  ...
  static BorderRadius borderRadius = BorderRadius.circular(10.r);
  static BorderRadius sBorderRadius = BorderRadius.circular(8.r);
  static EdgeInsetsGeometry commonSpacer = EdgeInsets.only(bottom: 12.h);
  static double titleSize = 16.sp;
  static double cardPadding = 12.w;
  static double cardTitleSize = 13.sp;
  static double addressSize = 12.sp;
  static double svgSize = 14;
  static double iconSize = 16.w;
  static double svgCardSize = 35;
  static EdgeInsetsGeometry cardHPadding = EdgeInsets.symmetric(horizontal: 8.w);
  static EdgeInsetsGeometry cardAllPadding = EdgeInsets.all(10.w);
  static EdgeInsetsGeometry sCardAllPadding = EdgeInsets.all(8.w);
