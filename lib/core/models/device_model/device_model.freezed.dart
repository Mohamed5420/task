...
class _$DeviceModelImpl implements _DeviceModel {
  ...
  @override
  String toString() {
    return 'DeviceModel(locale: $locale, auth: $auth, isBundle: $isBundle, isTablet: $isTablet, isSmallPhone: $isSmallPhone, isNetworkConnected: $isNetworkConnected, logged: $logged, themeMode: $themeMode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, locale, auth, isBundle, isTablet,
      isSmallPhone, isNetworkConnected, logged, themeMode);
